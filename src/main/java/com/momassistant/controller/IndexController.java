...
private WeiXinMessageService weiXinMessageService;
    ...
    private WeiXinTemplate buildWeixinTemplate() {
        ...
        gestationMessageData.setFirst(new WeiXinSendValue(String.format(FIRST_TEMPLATE, "1", "xxx"), Color.BLACK.getCode()));
        gestationMessageData.setKeyword1(new WeiXinSendValue(DateUtil.format(new Date()), Color.BLACK.getCode()));
        gestationMessageData.setRemark(new WeiXinSendValue("点击查看本次产检更多注意事项吧~", Color.BLACK.getCode()));
        gestationMessageData.setKeyword2(new WeiXinSendValue("blabla~~~", Color.BLACK.getCode()));
